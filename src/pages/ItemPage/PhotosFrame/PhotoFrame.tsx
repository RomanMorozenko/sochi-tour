  ...
  return (
    <div className={s.container}>
      <div
        ...
        style={{
          background: `url(https://xn--80aabjhkiabkj9b0amel2g.xn--p1ai/static/city/9830-5971.jpg)`,
          backgroundSize: 'cover'
        }}
        className={s.mainItem}></div>
