...
export const ExcursionItemPage = () => {
  ...
  const excursionsData: ExcursionsCollectionResponseType = useSelector(
    (state: AppRootStateType) => state.excursions
  );
      ...
      <div className={s.gridContainer}>
        ...
        <section className={s.description}>
          ...
          {excursion.description.map((item, index) => {
            return (
              <section key={index} className={s.sectionParagraph}>
                {item}
              </section>
            );
          })}
